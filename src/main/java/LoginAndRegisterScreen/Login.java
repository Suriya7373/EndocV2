...
import java.time.Duration;
   ...
   public class Login {
       ...
       driver.get("https://testv2.endocpm.com/login");
       driver.manage().window().maximize();

      //Enter username

       //LoginpagePOM loginpagePOM=new LoginpagePOM();
       LoginpagePOM.username(driver).sendKeys("suriyaganesh@bmsmartware.com");
       //Entering  password
       LoginpagePOM.Password(driver).sendKeys("Endoc@123");
       //Enter signup
       LoginpagePOM.Signin(driver).click();
            //choosing organization
            LoginpagePOM.organization (driver).click();
            //choosing facility
            Thread.sleep(2000);
            LoginpagePOM.facility(driver).click();
